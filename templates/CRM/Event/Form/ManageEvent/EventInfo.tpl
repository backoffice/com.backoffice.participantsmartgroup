...
{else}
  ...
  <table class="form-layout-compressed">
    ...
    {* Start adding Create Smartgroup checkbox on event form *}
    <tr class="crm-event-manage-eventinfo-form-block-create_smartgroup">
      <td>&nbsp;</td>
      <td>{$form.create_smartgroup.html} {$form.create_smartgroup.label} {help id="id-create_smartgroup"}</td>
    </tr>
    {* end Adding *}
    {if $eventID}
    <tr>
